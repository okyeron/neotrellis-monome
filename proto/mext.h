...
static size_t outgoing_payload_lengths[16][16] =
    {[0 ... 15][0 ... 15] = 0,
     ...
     [SS_SYSTEM] =
         {
                 [CMD_SYSTEM_QUERY] = 0, [CMD_SYSTEM_GET_ID] = 0,
                 [CMD_SYSTEM_SET_ID] = 32, [CMD_SYSTEM_GET_OFFSETS] = 0,
                 [CMD_SYSTEM_SET_OFFSET] = 3, [CMD_SYSTEM_GET_GRIDSZ] = 0,
                 [CMD_SYSTEM_SET_GRIDSZ] = 2, [CMD_SYSTEM_GET_ADDR] = 0,
                 [CMD_SYSTEM_SET_ADDR] = 2, [CMD_SYSTEM_GET_VERSION] = 0,
         },

     [SS_LED_GRID] = {[CMD_LED_ON] = 2, [CMD_LED_OFF] = 2, [CMD_LED_ALL_ON] = 0,
                      [CMD_LED_ALL_OFF] = 0, [CMD_LED_MAP] = 10,
                      [CMD_LED_ROW] = 3, [CMD_LED_COLUMN] = 3,
                      [CMD_LED_INTENSITY] = 1, [CMD_LED_LEVEL_SET] = 3,
                      [CMD_LED_LEVEL_ALL] = 1, [CMD_LED_LEVEL_MAP] = 34,
                      [CMD_LED_LEVEL_ROW] = 6, [CMD_LED_LEVEL_COLUMN] = 6 },

     [SS_LED_RING] = {[CMD_LED_RING_SET] = 3, [CMD_LED_RING_ALL] = 2,
                      [CMD_LED_RING_MAP] = 33, [CMD_LED_RING_RANGE] = 4 },

     [SS_TILT] = {[CMD_TILT_STATE_REQ] = 0, [CMD_TILT_ENABLE] = 1,
                  [CMD_TILT_DISABLE] = 1 } };

static size_t incoming_payload_lengths[16][16] =
    {[0 ... 15][0 ... 15] = 0,

     [SS_SYSTEM] = {[CMD_SYSTEM_QUERY_RESPONSE] = 2, [CMD_SYSTEM_ID] = 32,
                    [CMD_SYSTEM_GRID_OFFSET] = 3, [CMD_SYSTEM_GRIDSZ] = 2,
                    [CMD_SYSTEM_ADDR] = 2, [CMD_SYSTEM_VERSION] = 8 },

     [SS_KEY_GRID] = {[CMD_KEY_DOWN] = 2, [CMD_KEY_UP] = 2 },

     [SS_ENCODER] = {[CMD_ENCODER_DELTA] = 2, [CMD_ENCODER_SWITCH_UP] = 1,
                     [CMD_ENCODER_SWITCH_DOWN] = 1 },

     [SS_TILT] = {[CMD_TILT_STATES] = 1, [CMD_TILT] = 7 } };
...
typedef int (*mext_handler_t)(struct mext *, const struct mext_msg *,
                              monome_event_t *);
